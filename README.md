...
Primero quiero comentar que fue un proceso muy entretenido y desafiante desarrollar esta aplicación.
Seré muy breve en explicar mi proceso. Comencé visualizando y entendiendo todo el proceso y todos los componentes involucrados que se mostraban en el documento de Figma.
Una vez entendido eso, decidí implementar dos herramientas para controlar los datos y los estados de mi aplicación:
1)	react-query: para gestionar los datos desde el servidor y no replicar toda esa información en la aplicación.
2)	useContext: sólo para controlar de manera global los contadores seleccionados, ya que, estos se debían requerir al momento de eliminar o compartir.

Las dependencias que utilicé para apoyarme en el desarrollo de algunos componentes, son:
- antd (Modal, Input)
- axios
- js-search-arra
- react-elastic-carousel 

Una vez desarrollada la estructura y todas las funcionalidades requeridas, comencé a integrar un diseño más detallado y personalizado, como se indicaba, a todos los componentes.

Muchas Gracias por este desafío!
